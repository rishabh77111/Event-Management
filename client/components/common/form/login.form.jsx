...
//                 Don't have an account? <Link href="/register" className="text-gray-900 font-bold hover:underline">Sign up</Link>
//             </p>
//         </div>
//     );
// };
        ...
        <div className="max-w-md mx-auto mt-20 bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            >
                ...
                <Button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gray-900 text-white py-3 rounded-lg hover:bg-black focus:ring-4 focus:ring-gray-200 shadow-md"
                >
                    {loading
                        ? 'Processing...'
                        : showOTP
